...
Alright, everything should be set up now. Let’s test it! Head to the *General* tab of your CloudFront distribution, copy the *Distribution domain name*, and paste it into a new browser tab.
